   ...
   // 1. Define your form.
      ...
      return (
            <Form {...form}>
              ...
              <h2 className="h3-bold text-center mb-2 text-gray-800">Forgot Password</h2>
              <p className="text-gray-600 small-medium md:base-regular text-center mb-6">
              Write the email you used to register and we will send you a link to reset your password
              </p>
